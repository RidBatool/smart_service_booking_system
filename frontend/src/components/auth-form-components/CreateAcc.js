  ...
  return (
    <section className="create-acc-section login-section">
      <div className="create-account-container login-container">
        ...
        {/* 
        NOTE: This link directs users to Rida Clinic's "terms and conditions page". As this is a fictitious company, it serves as a placeholder link 
        ...
        */}
        ...
        {/* 
        NOTE: This link directs users to Rida Clinic's website for customers. As this is a fictitious company, it serves as a placeholder link 
        to demonstrate application functionality. This will be addressed in future revisions. 
        */}
